...
public class UdpTelemetrySimulator {
    ...
    // Use AtomicInteger for thread-safe sequence counting
    private static final AtomicInteger sequenceCount = new AtomicInteger(0);  
    ...
    private static byte[] generateTelemetryData(byte[] payload) {
        ...
        // Add 4-byte sequence count using AtomicInteger to ensure thread-safety
        buffer.putInt(sequenceCount.getAndIncrement());
